...
// **********************
    ...
    var SVO_instruction = {
      ...
      <br> 
      <br>
      <b> 100 points are worth 0.30£ (about 7.16 Rand).  </b>
     ...
     var star_instructions = {
      ...
      stimulus: function(){
        return `
         ...
         <p>${globalgroup_text} wins if you gather more points than ${globalothergroup_text}. The winning team gets a bonus payment of 0.60£ (about 14.32 Rand). </br> </br></p> 
 ...
 var star_test_stimuli = [
    ...
    var choice_instructions1 = {
      ...
      <p> 100 points are worth 0.30£ (about 7.16 Rand). Each decision you make has the same chance to be picked to be paid out.<p/> 
    ...
    var lookcheck_trial = {
      ...
      stimulus: function() {
        return `
         <p>In this task, you have 100 points that are worth 0.30£ (about 7.16 Rand).</p> 
