   ...
   /* preload images */
    ...
    var jsPsych = initJsPsych({
      ...
      on_trial_finish: function () {if(successExp) {
        ...
        Your survey code is: <b><b>Cog${randomCode}Glo11</b></br>
...
// **********************
    ...
    var SVO_instruction = {
      ...
      <br> 
      <br>
      <b> 100 points are worth 0.37¢ (about 32 Afghani).  </b>
     ...
     var star_instructions = {
      ...
      stimulus: function(){
        return `
         ...
         <p>${globalgroup_text} wins if you gather more points than ${globalothergroup_text}. The winning team gets a bonus payment of 0.74$ (about 65 Afghani). </br> </br></p> 
 ...
 var star_test_stimuli = [
    ...
    var choice_instructions1 = {
      ...
      <p> 100 points are worth 0.37¢ (about 32 Afghani). Each decision you make has the same chance to be picked to be paid out.<p/> 
    ...
    var lookcheck_trial = {
      ...
      stimulus: function() {
        return `
         <p>In this task, you have 100 points that are worth 0.37$ (about 32 Afghani).</p> 
    ...
    var on_finish_callback = function () {
        ...
        $.ajax({
           ...
           .done(function () {
            ...
            "Your survey code is: <b> Cog28392832Glo00." +
